...
Recurso workers are not terminated merely because the parent Pi session ends.
Use `/recurso-stop-all` when you intentionally want to stop every live worker
